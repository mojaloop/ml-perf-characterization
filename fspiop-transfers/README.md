...
---------|----------|---------|---------|---------|---------
 ...
 13.1 |** FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 with cache config enabled - scale:1, 2 DFSPs, k6vu:MAX ** | 1 | Y | fspiopTransfers | 
 13.2 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 with cache config enabled - scale:1, 2 DFSPs, Kafkapartitions: position=25,rest of partitions 19, k6vu:MAX | 1 | Y | fspiopTransfers | 
 13.3 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 with cache config enabled - scale:1, 2 DFSPs, Kafkapartitions: 4, 25, 25, 4, k6vu:MAX | 1 | Y | fspiopTransfers |
 13.4 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 with cache config enabled - scale:1, 2 DFSPs, Kafkapartitions: all 19,  k6vu:MAX | 1 | Y | fspiopTransfers |
 13.5 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 with cache config enabled - scale:1, 2 DFSPs, Kafkapartitions: 19, 25, 19, 19, kafka config changes on ML-API only, k6vu:MAX | 1 | Y | fspiopTransfers |
 13.6 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 with cache config enabled - scale:1, 2 DFSPs, Kafkapartitions: 19, 25, 19, 19, kafka config changes on CL only, k6vu:MAX | 1 | Y | fspiopTransfers |
 13.7 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 with cache config enabled - scale:1, 2 DFSPs, Kafkapartitions: 19, 25, 19, 19, kafka config changes on both CL & ML-API, k6vu:MAX | 1 | Y | fspiopTransfers |
 13.8 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 with cache config enabled - scale:1, 2 DFSPs, Kafkapartitions: 19, 25, 19, 19, kafka config changes on ML-API & CL, CL with removed "compression.codec": "lz4", k6vu:MAX | 1 | Y | fspiopTransfers |
 13.9 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 with cache config enabled - scale:1, 2 DFSPs, Kafkapartitions: 19, 25, 19, 19, kafka config changes on ML-API & CL, Central handler - sync is false only, k6vu:MAX | 1 | Y | fspiopTransfers |
 13.10 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 with cache config enabled - scale:1, 2 DFSPs, Kafkapartitions: 19, 25, 19, 19, kafka config changes on ML-API & CL, Central handler - sync is false & queue.buffering.max.messages": 0, k6vu:MAX | 1 | Y | fspiopTransfers |
 S58.1 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 + s4, 4notify, 8pos - 8 dfsps + extra notification switched off via config + logging on + audit logs on + UV_THREAD_POOL 24 + 30vus + Ml Notification JSON.stringify fix + reduced IOPS + bin_log off + local mysql + partitions 19 + kafka partition.assignment.strategy=cooperative-sticky + Central services shared HTTP keep-alive + Central services shared logger fixes, k6vu:MAX | 1 | Y | fspiopTransfers |
 S58.2 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 + s4, 4notify, 8pos - 8 dfsps + extra notification switched off via config + logging on + audit logs on + UV_THREAD_POOL 24 + 30vus + Ml Notification JSON.stringify fix + reduced IOPS + bin_log off + local mysql + partitions 19, 25, 19, 19 + kafka partition.assignment.strategy=cooperative-sticky + Central services shared HTTP keep-alive + Central services shared logger fixes, k6vu:MAX | 1 | Y | fspiopTransfers |
 S58.3 | FSPIOP Transfers POST /transfers with CL v17.2.0 & ML-API v.14.0.4 + s4, 4notify, 8pos - 8 dfsps + extra notification switched off via config + logging on + audit logs on + UV_THREAD_POOL 24 + 30vus + Ml Notification JSON.stringify fix + reduced IOPS + bin_log off + local mysql + partitions 4, 25, 25, 4 + kafka partition.assignment.strategy=cooperative-sticky + Central services shared HTTP keep-alive + Central services shared logger fixes, k6vu:MAX | 1 | Y | fspiopTransfers |
