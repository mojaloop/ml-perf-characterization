...
module.exports = {
   ...
   */
  title: 'ML Performance Characterization Documentation',
  /**
   * Ref：https://v1.vuepress.vuejs.org/config/#description
   */
  description: description,
  base: '/ml-perf-characterization/',
  ...
  themeConfig: {
    ...
    smoothScroll: true,
    logo: 'https://docs.mojaloop.io/mojaloop_logo_med.png',
    sidebarDepth: 2,
    lastUpdated: true,
    sidebar: [
      {
        ...
        children: [
          {
            ...
            path: '/cpu-profiling/ml-notification-handler/'
          },
          {
